'''
 # @ Author: Zongjing Li
 # @ Create Time: 2024-05-08 10:37:55
 # @ Modified by: Zongjing Li
 # @ Modified time: 2024-05-08 10:38:09
...
class FeatureDecoder(nn.Module):
    def __init__(self, inchannel,input_channel,object_dim = 100):
        ...
        self.register_buffer('x_grid', x_grid.clone().view((1, 1) + x_grid.shape))
        self.register_buffer('y_grid', y_grid.clone().view((1, 1) + y_grid.shape))
        self.bias = 0
