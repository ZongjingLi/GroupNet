...
model_record = full_library.get_record("dining_room_table")
...
commands.extend(TDWUtils.create_avatar(position={"x": 1.5, "y": 1.6, "z": 1.2},
                                       avatar_id="a",
